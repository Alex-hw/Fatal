...
$.ajax({url: "//live2d-cdn.fghrsh.net/assets/1.4.2/waifu-tips.min.js", dataType:"script", cache: true, success: function() {
        $.ajax({url: "//live2d-cdn.fghrsh.net/assets/1.4.2/live2d.min.js", dataType:"script", cache: true, success: function() {
                ...
                live2d_settings['waifuSize'] = '220x220';          // 看板娘大小
                live2d_settings['waifuTipsSize'] = '300x50';      // 提示框大小
                live2d_settings['waifuFontSize'] = '20px';         // 提示框字体
                live2d_settings['waifuEdgeSide'] = 'right:20';     // 看板娘贴边方向
                // live2d_settings['waifuEdgeSide'] = 'bottom:0';     // 看板娘贴边方向
                live2d_settings['waifuToolFont'] = '26px';         // 工具栏字体
                live2d_settings['waifuToolLine'] = '40px';         // 工具栏行高
